...
module.exports = BaseController.extend({
    ...
    register: async function (req, res, next) {
        ...
        v.render({
            title: 'Twitter-Capture | Register',
            session: req.session,
            i18n: res,
        })
    },
    forgotPassword: async function (req, res, next) {
        ...
        v.render({
            title: 'Twitter-Capture | Forgot password',
            session: req.session,
            i18n: res,
        })
    },
    ...
    verify_email: async function (req, res, next) {
        ...
        if (!token) {
            ...
            v.render({
                title: 'Twitter-Capture | Phone verify',
                session: req.session,
                i18n: res,
            })
        } else {
    ...
    postVerifyPhone: async function (req, res, next) {
        ...
        .then(function () {
            return smsapi.message.sms().from('Twitter-Capture').to(phone_number).message(verify_code).execute();
